...
def swap(lst):
    ...
    min_val = min(lst) # value
    min_index = lst.index(min_val) # index

    lst[0], lst[min_index] = lst[min_index], lst[0] # this line finds the first value and the minimum and switches their indexes
...
def count_spaces(string):
    ...
    *** Important: your code must use comprehensions and should not be more than
    ...
    return sum(1 for space in string if space == ' ')
